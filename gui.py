...
class App:
    def __init__(self, root):
        ...
        # Create a window with name Login frame
        self.login_frame = tk.Frame(self.root)
        self.login_frame.pack(padx=10, pady=10)

        # Create a label and input field in the login frame for login and password
        ...
        # Create an entry fields to fill in the Form Submission Frame
